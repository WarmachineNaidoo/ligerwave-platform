...
from app.routers import auth, homes, devices, events, api_keys, arming, subscriptions, export, webhooks, agent, wellness, ar, settings, zones, push, health, premium, admin, privacy, tomography, prison, estate
